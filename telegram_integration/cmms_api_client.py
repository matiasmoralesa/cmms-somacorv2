...
from bot_config import API_BASE_URL, API_TOKEN, API_TIMEOUT
...
class CMSSAPIClient:
    ...
    def update_usuario(self, usuario_id: int, data: Dict) -> Dict:
        """Actualizar un usuario específico (PATCH"""
        logger.info(f"Actualizando usuario ID: {usuario_id}")
        return self._make_request('PATCH', f'usuarios/{usuario_id}/', json=data)
